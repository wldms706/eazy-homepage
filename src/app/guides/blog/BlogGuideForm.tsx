...
export default function BlogGuideForm() {
  ...
  if (showVideo) {
    return (
      <div>
        ...
        <h2 className="video-title">블로그 무료 강의</h2>
        <iframe
          className="video-frame"
          src="https://www.youtube.com/embed/qwHrCsqFRM0?start=60&modestbranding=1&rel=0&showinfo=0"
  ...
  return (
    <div className="form-card">
      <p style={{ fontSize: "0.8rem", fontWeight: 700, color: "var(--accent)", letterSpacing: "2px", textTransform: "uppercase", textAlign: "center", marginBottom: "16px" }}>Free Guide</p>
      <h1 className="form-title">블로그 무료 강의</h1>
      <p className="form-desc">블로그 시작부터 상위노출까지 알려드립니다.<br />정보를 입력하시면 바로 영상을 시청할 수 있습니다. (1분부터 보시면 됩니다!)</p>
      ...
      <p style={{ fontSize: "0.75rem", color: "var(--text-sub)", textAlign: "center", marginTop: "8px", lineHeight: 1.6 }}>※ 본 영상은 무료 자료로, 영상 내용에 대한 별도 상담은 제공되지 않습니다.<br />※ 추후 유료 콘텐츠로 전환될 수 있습니다.</p>
    </div>
  );
}
